...
public class WXUtils {
    ...
    public static boolean sendTemplateMessage(String openId,String templateId,String readerId,String title,String returnDate,String phone)
    {
        try
        {
